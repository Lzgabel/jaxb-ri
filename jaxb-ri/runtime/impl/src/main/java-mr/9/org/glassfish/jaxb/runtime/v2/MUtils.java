...
final class MUtils {
    ...
    private static final Logger logger = Logger.getLogger("cn.lzgabel.jaxb.runtime");
    ...
    static void open(Class[] classes) throws JAXBException {
        final Module coreModule = cn.lzgabel.jaxb.core.v2.ClassFactory.class.getModule();
