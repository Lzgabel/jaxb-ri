...
public abstract class Lister<BeanT,PropT,ItemT,PackT> {
     ...
     */
    public abstract cn.lzgabel.jaxb.runtime.v2.runtime.reflect.ListIterator<ItemT> iterator(PropT multiValueProp, XMLSerializer context);
    ...
    private static final class ArrayLister<BeanT,ItemT> extends Lister<BeanT,ItemT[],ItemT,Pack<ItemT>> {
        ...
        @Override
        public cn.lzgabel.jaxb.runtime.v2.runtime.reflect.ListIterator<ItemT> iterator(final ItemT[] objects, XMLSerializer context) {
            return new cn.lzgabel.jaxb.runtime.v2.runtime.reflect.ListIterator<ItemT>() {
                int idx=0;
                @Override
    ...
    public static final class CollectionLister<BeanT,T extends Collection> extends Lister<BeanT,T,Object,T> {
        ...
        @Override
        public cn.lzgabel.jaxb.runtime.v2.runtime.reflect.ListIterator iterator(T collection, XMLSerializer context) {
            final Iterator itr = collection.iterator();
            return new cn.lzgabel.jaxb.runtime.v2.runtime.reflect.ListIterator() {
                @Override
                public boolean hasNext() {
                    return itr.hasNext();
                }
    ...
    private static final class IDREFS<BeanT,PropT> extends Lister<BeanT,PropT,String,IDREFS<BeanT,PropT>.Pack> {
        ...
        @Override
        public cn.lzgabel.jaxb.runtime.v2.runtime.reflect.ListIterator<String> iterator(PropT prop, XMLSerializer context) {
            final cn.lzgabel.jaxb.runtime.v2.runtime.reflect.ListIterator i = core.iterator(prop,context);
     ...
     */
    public static final class IDREFSIterator implements cn.lzgabel.jaxb.runtime.v2.runtime.reflect.ListIterator<String> {
        private final cn.lzgabel.jaxb.runtime.v2.runtime.reflect.ListIterator i;
        private final XMLSerializer context;
        private Object last;

        private IDREFSIterator(cn.lzgabel.jaxb.runtime.v2.runtime.reflect.ListIterator i, XMLSerializer context) {
            this.i = i;
    ...
    public static final Lister ERROR = new Lister() {
        @Override
        public cn.lzgabel.jaxb.runtime.v2.runtime.reflect.ListIterator iterator(Object o, XMLSerializer context) {
    ...
    private static final cn.lzgabel.jaxb.runtime.v2.runtime.reflect.ListIterator EMPTY_ITERATOR = new ListIterator() {
        @Override
        public boolean hasNext() {
            return false;
        }
