 ...
 *      the operations.
 *  <li>{@link cn.glassfish.jaxb.runtime.v2.runtime.JAXBContextImpl} builds itself by reading the model and
 ...
 *
 * <dl>
 *  <dt>{@code cn.glassfish.jaxb.core.v2.model model}
 *  <dd>
 *    This set of classes and interfaces models JAXB-bound types.
 *
 *  <dt>{@link cn.glassfish.jaxb.core.v2.runtime XML I/O}
 *  <dd>
 *    This set of classes implements the JAXB API and provides the XML I/O functionality.
 * </dl>
 *
 * <p>
 * The classes <b>NOT</b> in the {@link cn.glassfish.jaxb.core.v2} package (and its subpackages)
