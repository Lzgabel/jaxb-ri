...
import cn.glassfish.jaxb.runtime.util.ValidationEventLocatorExImpl;
...
import cn.glassfish.jaxb.runtime.v2.runtime.output.MTOMXmlOutput;
import cn.glassfish.jaxb.runtime.v2.runtime.output.NamespaceContextImpl;
import cn.glassfish.jaxb.runtime.v2.runtime.output.Pcdata;
import cn.glassfish.jaxb.runtime.v2.runtime.output.XmlOutput;
...
import cn.glassfish.jaxb.runtime.v2.runtime.unmarshaller.IntData;
import cn.glassfish.jaxb.runtime.v2.util.CollisionCheckStack;
...
public final class XMLSerializer extends Coordinator {
        ...
        if(seenRoot) {
            ...
            if(data != null)
                try {
                    ...
                    throw new IllegalArgumentException(cn.glassfish.jaxb.runtime.v2.runtime.Messages.ILLEGAL_CONTENT.format(fieldName, e.getMessage()));
                }
            out.endTag(tagName);
            nse = nse.pop();
        } else {
    ...
    public String onIDREF( Object obj ) throws SAXException {
        ...
        if(id==null) {
            reportError( new NotIdentifiableEventImpl(
                ...
                cn.glassfish.jaxb.runtime.v2.runtime.Messages.NOT_IDENTIFIABLE.format(),
    ...
    private Object pushObject(Object obj, String fieldName) throws SAXException {
        ...
        reportError(new ValidationEventImpl(
            ValidationEvent.ERROR,
            cn.glassfish.jaxb.runtime.v2.runtime.Messages.CYCLE_IN_MARSHALLER.format(cycleDetectionStack.getCycleString()),
            ...
            if(!asExpected) {
                ...
                if(actual==expected)
                    ...
                    if(actualTypeName==null) {
                        reportError(new ValidationEventImpl(
                                ValidationEvent.ERROR,
                                cn.glassfish.jaxb.runtime.v2.runtime.Messages.SUBSTITUTED_BY_ANONYMOUS_TYPE.format(
    ...
    void reconcileID() throws SAXException {
        ...
        for( Object idObj : idReferencedObjects ) {
            try {
                ...
                reportError( new NotIdentifiableEventImpl(
                    ValidationEvent.ERROR,
                    cn.glassfish.jaxb.runtime.v2.runtime.Messages.DANGLING_IDREF.format(id),
    ...
    private void reportMissingObjectError(String fieldName) throws SAXException {
        reportError(new ValidationEventImpl(
            ValidationEvent.ERROR,
            cn.glassfish.jaxb.runtime.v2.runtime.Messages.MISSING_OBJECT.format(fieldName),
                getCurrentLocation(fieldName),
    ...
    public void errorMissingId(Object obj) throws SAXException {
        reportError( new ValidationEventImpl(
            ValidationEvent.ERROR,
            cn.glassfish.jaxb.runtime.v2.runtime.Messages.MISSING_ID.format(obj),
            new ValidationEventLocatorImpl(obj)) );
    }
