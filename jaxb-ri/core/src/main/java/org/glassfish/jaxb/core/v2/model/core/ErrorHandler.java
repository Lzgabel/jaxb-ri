 ...
 * Implemented by the client of {@link cn.glassfish.jaxb.core.v2.model.impl.ModelBuilderI}.
 *
 * <p>
 * All the static errors have to be reported while constructing a
 * model, not when a model is used (IOW, until the {@link cn.glassfish.jaxb.core.v2.model.impl.ModelBuilderI} completes.
 * Internally, {@link cn.glassfish.jaxb.core.v2.model.impl.ModelBuilderI} wraps an {@link ErrorHandler} and all the model
 ...
 *
 * @see cn.glassfish.jaxb.core.v2.model.impl.ModelBuilderI
